...
.systeminfo td, .systeminfo th { color:#555; border: 1px solid #cccccc; font-size: small; vertical-align: baseline;}
.systeminfo h1 {font-size: 150%; text-align:left;}
.systeminfo h2 {font-size: 125%;}
.systeminfo .p {text-align: left;}
.systeminfo .e {background-color: #f5f5fc; color: #555;}
.systeminfo .h {background-color: #9999cc; font-weight: bold; color: #555;}
.systeminfo .v {background-color: #fcfcfc; color: #555;}
.systeminfo .vr {background-color: #fcfcfc; text-align: right; color: #555;}
.systeminfo hr {width: 600px; background-color: #fcfcfc; border: 0px; height: 1px; color: #555;}
</style>';
